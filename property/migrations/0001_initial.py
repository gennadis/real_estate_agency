    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.TextField(blank=True, verbose_name="Текст объявления"),
                ),
                (
                    "price",
                    models.IntegerField(db_index=True, verbose_name="Цена квартиры"),
                ),
                (
                    "town",
                    models.CharField(
                ...
                (
                    "rooms_number",
                    models.IntegerField(
                        db_index=True, verbose_name="Количество комнат в квартире"
                    ),
                ),
                (
                    "living_area",
                ...
                (
                    "construction_year",
                    models.IntegerField(
                        db_index=True, null=True, verbose_name="Год постройки здания"
                    ),
                ),
            ],
        ),
